...
import org.openhab.binding.daikinir.internal.api.DaikinUnitState.TIMER_MODE;
...
public class DaikinUnitTransmitter {
    ...
    public void transmit() {
        isStateAcurate = true;
        BroadlinkInterface broadlinkIf = new BroadlinkInterface();
        // Frame 1
        int[] frame1 = buildFrame1();
        broadlinkIf.AddFrame(frame1);
        // Frame 2
        int[] frame2 = buildFrame2();
        broadlinkIf.AddFrame(frame2);
        // Frame 3
        int[] frame3 = buildFrame3();
        broadlinkIf.AddFrame(frame3);

        broadlinkIf.send();

        logger.info("Frame1: {}", BinaryUtils.bytesToString(frame1));
        logger.info("Frame2: {}", BinaryUtils.bytesToString(frame2));
        logger.info("Frame3: {}", BinaryUtils.bytesToString(frame3));

        // try {
        // FileWriter fileWriter = new FileWriter("/home/jordi/testOut.txt");
        // fileWriter.write(BinaryUtils.bytesToString(frame1));
        // fileWriter.write(BinaryUtils.bytesToString(frame2));
        // fileWriter.write(BinaryUtils.bytesToString(frame3));
        // fileWriter.close();
        // } catch (IOException e) {
